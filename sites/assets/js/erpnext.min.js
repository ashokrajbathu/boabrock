...
/*
 *	/home/weboc/frappe-bench/apps/erpnext/erpnext/public/js/conf.js
 */
...
/*
 *	/home/weboc/frappe-bench/apps/erpnext/erpnext/public/js/feature_setup.js
 */
// Copyright (c) 2015, Frappe Technologies Pvt. Ltd. and Contributors
// License: GNU General Public License v3. See license.txt
...
/*
 *	/home/weboc/frappe-bench/apps/erpnext/erpnext/public/js/utils.js
 */
// Copyright (c) 2015, Frappe Technologies Pvt. Ltd. and Contributors
// License: GNU General Public License v3. See license.txt
frappe.provide("erpnext");
...
/*
 *	/home/weboc/frappe-bench/apps/erpnext/erpnext/public/js/queries.js
 */
// Copyright (c) 2015, Frappe Technologies Pvt. Ltd. and Contributors
// License: GNU General Public License v3. See license.txt
...
/*
 *	/home/weboc/frappe-bench/apps/erpnext/erpnext/public/js/utils/party.js
 */
// Copyright (c) 2015, Frappe Technologies Pvt. Ltd. and Contributors
// License: GNU General Public License v3. See license.txt
...
frappe.templates["address_list"] = '<p><button class="btn btn-sm btn-default btn-address"> <i class="icon-plus"></i> New Address</button></p> {% for(var i=0, l=addr_list.length; i<l; i++) { %} <hr> <a href="#Form/Address/{%= addr_list[i].name %}" class="btn btn-sm btn-default pull-right"> {%= __("Edit") %}</a> <p><b>{%= i+1 %}. {%= addr_list[i].address_type %}</b></p> <div style="padding-left: 15px;"> <div> {% if(addr_list[i].is_primary_address) { %}<span class="label label-info"> {%= __("Primary") %}</span>{% } %} {% if(addr_list[i].is_shipping_address) { %}<span class="label label-default"> {%= __("Shipping") %}</span>{% } %} </div> <p style="margin-top: 5px;">{%= addr_list[i].display %}</p> </div> {% } %} {% if(!addr_list.length) { %} <p class="text-muted">{%= __("No address added yet.") %}</p> {% } %} ';
...
/*
 *	/home/weboc/frappe-bench/apps/erpnext/erpnext/public/js/pos/pos.js
 */
// Copyright (c) 2015, Frappe Technologies Pvt. Ltd. and Contributors
// License: GNU General Public License v3. See license.txt
